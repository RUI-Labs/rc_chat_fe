<template>
  ...
  <template v-else>
    ...
    <div class="z-50 w-full flex flex-col justify-center items-center">
      <h1 class="text-6xl font-brand font-bold mb-4">Welcome!</h1>

      <h1 class="text-2xl font-brand font-bold mb-4 text-center">To participate in events by <span class="bg-black text-white rounded-full mx-2 px-3 p-2">Ruilabs on REMO</span>, please get a stamp.</h1>
