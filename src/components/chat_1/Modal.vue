            ...
            <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
              <DialogPanel id="mainCard"  class="w-full h-full flex justify-center items-center">
                ...
                <div v-if="!noStamp" ref="stampEl" :class="[zoomStamp ? 'scale-100' : 'scale-75', 'duration-300 transition-transform']" class="w-[300px] h-[300px] fixed z-40 bottom-0 left-0 pointer-events-none">
                  <StampCircle :diameter="200" address="0xcB35ed9B8a830fA472931cc63a62793910c59270" name="jesse"></StampCircle>
                </div>
                ...
                <section class="w-full max-w-md bg-white relative rounded-xl">
                  ...
                  <div class="p-8 mt-4">
                    ...
                    <h1 class="text-4xl font-brand font-bold">Lorem ipsum dolor sit amet lorem ipsum</h1>
                  </div>
