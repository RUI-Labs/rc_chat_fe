...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_HO30wqvn.mjs';
import { A as AstroError, i as i18nNoLocaleFoundInPath, f as appendForwardSlash, j as joinPaths, g as MiddlewareNoDataOrNextCalled, h as MiddlewareNotAResponse, G as GetStaticPathsRequired, k as InvalidGetStaticPathsReturn, l as InvalidGetStaticPathsEntry, m as GetStaticPathsExpectedParams, n as GetStaticPathsInvalidRouteParam, t as trimSlashes, P as PageNumberParamNotFound, o as NoMatchingStaticPathFound, p as PrerenderDynamicEndpointPathCollide, q as ReservedSlotName, L as LocalsNotAnObject, r as PrerenderClientAddressNotAvailable, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, s as RewriteWithBodyUsed, u as AstroResponseHeadersReassigned, R as ResponseSentError, v as fileExtension, w as slash$1, x as prependForwardSlash, y as removeTrailingForwardSlash } from './chunks/astro/assets-service_kp3Ss3ih.mjs';
import { R as ROUTE_TYPE_HEADER, c as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, e as renderSlotToString, f as renderJSX, g as chunkToString, i as isRenderInstruction, h as clientLocalsSymbol, j as clientAddressSymbol$1, k as renderPage, l as renderEndpoint, A as ASTRO_VERSION, m as responseSentSymbol, n as REROUTABLE_STATUS_CODES, o as commonjsGlobal } from './chunks/astro/server_BtvYfb51.mjs';
import 'cookie';
import { A as AstroCookies, s as sequence, d as defineMiddleware, o as onRequest } from './chunks/_astro-internal_middleware_BFQf-NTF.mjs';
import 'clsx';
...
const _page1 = () => import('./pages/admin/chat.astro.mjs');
const _page2 = () => import('./pages/admin/login.astro.mjs');
const _page3 = () => import('./pages/admin/project/_id_/campaign/_id_.astro.mjs');
const _page4 = () => import('./pages/admin/project/_id_/users.astro.mjs');
const _page5 = () => import('./pages/admin/project/_id_.astro.mjs');
const _page6 = () => import('./pages/admin/users.astro.mjs');
const _page7 = () => import('./pages/admin.astro.mjs');
const _page8 = () => import('./pages/api/campaigns.json.astro.mjs');
const _page9 = () => import('./pages/api/contactbook.json.astro.mjs');
const _page10 = () => import('./pages/api/keys.json.astro.mjs');
const _page11 = () => import('./pages/api/logout.json.astro.mjs');
const _page12 = () => import('./pages/api/logs.json.astro.mjs');
const _page13 = () => import('./pages/api/nonce.json.astro.mjs');
const _page14 = () => import('./pages/api/project/_project_.json.astro.mjs');
const _page15 = () => import('./pages/api/projects/_id_/campaigns.json.astro.mjs');
const _page16 = () => import('./pages/api/projects/_id_/users.json.astro.mjs');
const _page17 = () => import('./pages/api/projects.json.astro.mjs');
const _page18 = () => import('./pages/api/token.json.astro.mjs');
const _page19 = () => import('./pages/api/uploadstamp.json.astro.mjs');
const _page20 = () => import('./pages/api/verify.json.astro.mjs');
const _page21 = () => import('./pages/api/wallet/_wallet_.json.astro.mjs');
const _page22 = () => import('./pages/campaign.astro.mjs');
const _page23 = () => import('./pages/chat.astro.mjs');
const _page24 = () => import('./pages/new.astro.mjs');
const _page25 = () => import('./pages/project/_project_.astro.mjs');
const _page26 = () => import('./pages/project.astro.mjs');
const _page27 = () => import('./pages/project_1/_project_.astro.mjs');
const _page28 = () => import('./pages/index.astro.mjs');
const pageMap = new Map([
    ["node_modules/.pnpm/astro@4.11.3_sass@1.77.6_typescript@5.5.2/node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/admin/chat.astro", _page1],
    ["src/pages/admin/login.astro", _page2],
    ["src/pages/admin/project/[id]/campaign/[id].astro", _page3],
    ["src/pages/admin/project/[id]/users.astro", _page4],
    ["src/pages/admin/project/[id]/index.astro", _page5],
    ["src/pages/admin/users.astro", _page6],
    ["src/pages/admin/index.astro", _page7],
    ["src/pages/api/campaigns.json.ts", _page8],
    ["src/pages/api/contactbook.json.ts", _page9],
    ["src/pages/api/keys.json.ts", _page10],
    ["src/pages/api/logout.json.ts", _page11],
    ["src/pages/api/logs.json.ts", _page12],
    ["src/pages/api/nonce.json.ts", _page13],
    ["src/pages/api/project/[project].json.ts", _page14],
    ["src/pages/api/projects/[id]/campaigns.json.ts", _page15],
    ["src/pages/api/projects/[id]/users.json.ts", _page16],
    ["src/pages/api/projects.json.ts", _page17],
    ["src/pages/api/token.json.ts", _page18],
    ["src/pages/api/uploadstamp.json.ts", _page19],
    ["src/pages/api/verify.json.ts", _page20],
    ["src/pages/api/wallet/[wallet].json.ts", _page21],
    ["src/pages/campaign.astro", _page22],
    ["src/pages/chat.astro", _page23],
    ["src/pages/new.astro", _page24],
    ["src/pages/project/[project].astro", _page25],
    ["src/pages/project.astro", _page26],
    ["src/pages/project_1/[project].astro", _page27],
...
const _args = {
    "middlewareSecret": "0f4f565a-9f02-4943-b03f-44898342a0a5",
